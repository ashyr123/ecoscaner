...
# Mobil web app (web/index.html) — isteğe bağlı; bot için zorunlu değil
GEMINI_API_KEY: str = os.getenv("GEMINI_API_KEY", "")

# Mobil Telegram Web App (HTTPS URL, /app ile biter)
WEBAPP_URL: str = os.getenv("WEBAPP_URL", "http://127.0.0.1:5000/app")
